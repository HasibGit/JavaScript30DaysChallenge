  ...
  const ans3 = inventors.sort((a, b) => (a.year >= b.year ? 1 : -1));
  //console.table(ans3);

  // Array.prototype.reduce()
  // 4. How many years did all the inventors live all together?
  const ans4 = inventors.reduce((total, inventor) => (total += inventor.passed - inventor.year), 0);
  //console.log(ans4);
  ...
  const ans7 = data.reduce((obj,item) => {
         if(!obj[item]){
           obj[item] = 0;
         }
         obj[item]++;
